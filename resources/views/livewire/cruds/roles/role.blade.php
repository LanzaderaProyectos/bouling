                        ...
                        <table>
                            <thead>
                                <tr class="text-uppercase">
                                    ...
                                    <th style="width: 30%">Key value</th>
                            ...
                            <tbody>
                                @foreach ($roles as $role)
                                    <tr>
                                            ...
                                            <div class="flex">
                                                <div class="mr-1">
                                                    ...
                                                    <x-primary-button class="px-2"
                                                        wire:click="editOrDelete('{{ $role->id }}', 'edit')">
                                                        <x-slot name="slot">
                                        ...
                                        <td class="border px-4 py-2">{{ $role->name ?? '' }}
                                        </td>
                                        <td class="border px-4 py-2">{{ $role->key_value ?? '' }}
                                        </td>
                                        <td class="border px-4 py-2">{{ $role->type ?? '' }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
